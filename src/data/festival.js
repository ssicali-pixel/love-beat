...
export const TAPPE = [
  {
    ...
    artists: [
      ...
      {
        id: 'digweed-cat-fri', name: 'John Digweed', slug: 'john-digweed',
        date: '2026-07-11', time: '01:30', stage: 'main',
        genre: 'Progressive House', origin: 'UK', headliner: false, tappaId: 'catania',
...

  {
    ...
    artists: [
      ...
      {
        id: 'peggy-agr-sat', name: 'Peggy Gou', slug: 'peggy-gou',
        date: '2026-07-26', time: '02:00', stage: 'porto',
        genre: 'House / Disco', origin: 'Corea del Sud', headliner: true, tappaId: 'agrigento',
